...
#icon
image_icon = PhotoImage(file=r"C:\BMI CALCULATOR\icon.png")
root.iconphoto(False, image_icon)

#top
top_image = PhotoImage(file=r"C:\BMI CALCULATOR\top.png")
top_image_label = Label(root, image=top_image)
top_image_label.place(x=10, y=10)

#bottom
Label(root,width=72,height=18,bg="lightblue").pack(side=BOTTOM)

#two boxes
box = PhotoImage(file=r"C:\BMI CALCULATOR\box.png")
Label(root, image=box).place(x=20,y=100)
Label(root, image=box).place(x=240,y=100)

#scale
scale=PhotoImage(file=r"C:\BMI CALCULATOR\scale.png")
...
def slider_changed(event):
    ...
    img=(Image.open(r"C:\BMI CALCULATOR\man.png"))
